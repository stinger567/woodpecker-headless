...
func (s storage) PermFind(user *model.Account, repo *model.Repo) (*model.Perm, error) {
	perm := new(model.Perm)
...
func userPushOrAdminCondition(userID string) builder.Cond {
